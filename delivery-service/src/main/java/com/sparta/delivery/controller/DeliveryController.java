...
import com.sparta.delivery.security.AuthUser;
import com.sparta.delivery.security.CurrentUser;
...
public class DeliveryController {
    ...
    public ApiResponse<DeliveryCreateResponseDto> createDelivery(
        ...
        return deliveryService.createDelivery(request, authUser.userId(), authUser.role(), internalCaller);
    }
    ...
    public ApiResponse<DeliveryFindResponseDto> findDelivery(
        ...
        return deliveryService.findDelivery(deliveryId, userId, role);
    }
    ...
    public ApiResponse<DeliverySearchResponseDto> searchDelivery(
        ...
        return deliveryService.searchDelivery(status, destHubId, recipientName, pageable, userId, role);
    }
    ...
    public ApiResponse<DeliveryUpdateResponseDto> updateDelivery(
        ...
        return deliveryService.updateDelivery(deliveryId, request, userId, role);
    }
    ...
    public ApiResponse<List<DeliveryRouteSearchResponseDto>> findDeliveryRoutes(
        ...
        return deliveryService.findDeliveryRoutes(deliveryId, userId, role);
    }
    ...
    public ApiResponse<DeliveryRouteUpdateResponseDto> updateDeliveryRoute(
        ...
        return deliveryService.updateDeliveryRoute(deliveryRouteId, request, userId, role);
    }
}
